...
export default function Footer() {
  const cte1 = ["smartphones", "laptops", "fragrances", "skincare"];
  const cte2 = ["groceries", "home-decoration", "furniture", "tops"];
  const cte3 = ["womens-dresses", "womens-shoes", "mens-shirts", "mens-shoes"];
  const cte4 = [
    "mens-watches",
    "womens-watches",
    "womens-bags",
  ...
  const cte5 = ["sunglasses", "automotive", "motorcycle", "lighting"];
  return (
      ...
      <div className="bg-background/80">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-muted-foreground text-sm text-center sm:text-left">
            © 2024 DEPO —
            <a
              href="https://t.me/developer_23_05"
